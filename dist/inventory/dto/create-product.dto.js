...
__decorate([
    ...
    (0, class_validator_1.MinLength)(2, { message: 'Product name must be at least 2 characters' }),
    (0, class_validator_1.MaxLength)(255, { message: 'Product name must not exceed 255 characters' }),
...
__decorate([
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(0, { message: 'Low stock alert must be greater than or equal to 0' }),
    __metadata("design:type", Number)
