...
__decorate([
    (0, class_validator_1.IsUUID)(4, { message: 'Invalid product ID format' }),
...
__decorate([
    (0, class_validator_1.IsUUID)(4, { message: 'Invalid customer ID format' }),
    __metadata("design:type", String)
], CreateInvoiceDto.prototype, "customerId", void 0);
__decorate([
    (0, class_validator_1.IsDateString)({}, { message: 'Invalid due date format' }),
    __metadata("design:type", String)
