...
__decorate([
    (0, class_validator_1.IsEnum)(client_1.ExpenseCategory, { message: 'Invalid expense category' }),
...
__decorate([
    (0, class_validator_1.IsDateString)({}, { message: 'Invalid expense date format' }),
    __metadata("design:type", String)
